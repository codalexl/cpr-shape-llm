...
# Usage:
#   ./archive/ipd_rps/run_ipd_shaping.sh smoke   # 20-epoch smoke test (1 seed)
#   ./archive/ipd_rps/run_ipd_shaping.sh full    # 200-epoch full reproduction (3 seeds)
...
CONFIG="archive/ipd_rps/ipd_shaping_repro.json"
MODE="${1:-smoke}"
