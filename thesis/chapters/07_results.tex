...
A first-step take of 0 or 1 against a take-2 partner moves stock
\(8\to 9\).
At \(R=9\), mutual take-2 is a fixed point and the rest of the horizon can
be farmed.
That is a \textbf{basin switch at the opening}, not a 36-step dove policy.
...
\textbf{Whitened.}
Live take-1 fell \(6\%\to 3\%\); take-2 rose \(87\%\to 97\%\).
Survival was \(28/225\); deaths around round~4.
The critic was not myopic: raw opening A0 was about \(+39.8\) on open 1
versus \(+6.2\) on open 2 (about \(n=34\) versus \(n=177\) in the A0
photograph).
After whitening those became \(+1.38\) versus \(+0.75\).
Sign survived; scale did not.
The rare jackpot is the batch standard deviation, so the star shrinks
itself, and many openings of 2 outvote few openings of 1.
...
Seed 2 is not a failed replicate.
0 and 1 are the same opening family: take less than 2 at \(R=8\).
Which restraint token wins can move with the seed.
Whitened Test~A never left opening 2 and died.

\textbf{Claim.}
Against a frozen hawk, unflattened GAE is enough for PPO to leave the
death-open.
...
\textbf{Centre-only B.}
Survival \(223/225\).
Mix locked on take-2 (about \(81\%\to 98\%\)); take-3 died.
